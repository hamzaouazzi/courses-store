...
@NgModule({
    ...
    declarations: [HomeComponent, CourseCardListComponent, CourseDialogComponent, CourseComponent],
    exports: [HomeComponent, CourseCardListComponent, CourseDialogComponent, CourseComponent],
